				...
				<div class="jxjy_pages_content float_r">
					...
					<div class="jxjy_pages_text">
							...
							<ul id="list1">
								<c:forEach items="${pageBean.list}" var="x">
									<li><i
											class="icon-arrow2">●</i>
										<a
											title="${x.title}" target="_blank"><span style="color:#0387BF">
						...
						<div class="jxjy_paging">
							<!-- 文章列表分页 -->
							<form action="coursewareAction!listzyjnpxForPage"
								method="post">
								<!-- 项目列表分页 -->
								<ul>
									...
									<li class="c1">
										<a
											href="coursewareAction!listzyjnpxForPage?page=1"
											target="_self"><span id="first">首页</span> </a>&nbsp;
									</li>
									<li class="c2">
										<s:if test="%{pageBean.currentPage != 1}">
											<a
												href="coursewareAction!listzyjnpxForPage?page=<s:property value="%{pageBean.currentPage-1}"/>"
												target="_self"><span>上一页</span> </a>&nbsp;
									</s:if>
										<s:else>
											<a
												href="coursewareAction!listzyjnpxForPage?page=<s:property value="pageBean.currentPage"/>"
												target="_self"><span>上一页</span> </a>
										</s:else>
									</li>
									<li class="c3">
									...
									<li class="c4">
										<a
											href="coursewareAction!listzyjnpxForPage?page=<s:property value="pageBean.totalPage"/>"
