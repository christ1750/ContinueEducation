				...
				<div class="jxjy_pages_content float_r">
					...
					<div class="jxjy_pages_text">
						...
						<div class="jxjy_paging">
							<!-- 文章列表分页 -->
							<form action="coursewareAction!listhsjyForPage"
								method="post">
								<!-- 项目列表分页 -->
								<ul>
									...
									<li class="c1">
										<a
											href="coursewareAction!listhsjyForPage?page=1"
											target="_self"><span id="first">首页</span> </a>&nbsp;
									</li>
									<li class="c2">
										<s:if test="%{pageBean.currentPage != 1}">
											<a
												href="coursewareAction!listhsjyForPage?page=<s:property value="%{pageBean.currentPage-1}"/>"
												target="_self"><span>上一页</span> </a>&nbsp;
									</s:if>
										<s:else>
											<a
												href="coursewareAction!listhsjyForPage?page=<s:property value="pageBean.currentPage"/>"
												target="_self"><span>上一页</span> </a>
										</s:else>
									</li>
									<li class="c3">
									...
									<li class="c4">
										<a
											href="coursewareAction!listhsjyForPage?page=<s:property value="pageBean.totalPage"/>"
