							  ...
							  当前类别：<c:if test="${currentObject.role=='2'}">管理员</c:if>  
									...
									<div class="left">
										<label class="label" >
											设置过期时间
					                      	...
					                      	<input name="deadline" id="deadline" type="text" style="display:none;" value="${currentObject.deadline}" placeholder="格式为20160101"/>
										<br/>
									...
									<div class="box_3"
										...
										<s:submit method="updateUserInfo" type="image"
											src="images/signup_item/queren.gif" id="updateUserInfo" />
