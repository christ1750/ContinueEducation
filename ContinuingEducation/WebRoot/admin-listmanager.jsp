	...
	<body>
		...
		<div id="content" class="white">
			...
			<div class="bloc">
				...
				<div class="content">
						<form action="userManageAction!listmanagerForPage?page=1"
							method="post">
							<div class="fl">
								<div class="input">
									用户名:
				...
				<div class="content">
							...
							<display:column title="操作">
								<div id="actionBtnId">
									...
									<a class="white delButton"
										href="userManageAction!deleteUserInfo?searchUserID=${list.userId}&deletetype=2"
					...
					<form action="userManageAction!listmanagerForPage"
						method="post">
