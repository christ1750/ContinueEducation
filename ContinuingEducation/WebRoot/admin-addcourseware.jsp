			...
			<table>
				<tr>
					...
					<td><select name="category">
							<option></option>
							<option value="0">继续教育</option>
							<option value="1">函授教育</option>
							<option value="2">安全生产培训</option>
							<option value="3">职业技能培训</option>
					</select></td>
					<td>名称</td>
					<td><input type="text" name="title" /></td>
					<td>作者</td>
					<td><input type="text" name="author"
						value="<s:property value='#session.userInfo.realName'/>"
						disabled="disabled" /></td>
					<td>选择课件</td>
					<td><input type="file" name="upload" /></td>
					<td><s:submit value="提交内容" onclick="return checkpost()" />
					</td>
				</tr>
			</table>
