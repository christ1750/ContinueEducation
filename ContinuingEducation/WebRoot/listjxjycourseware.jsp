		...
		<div class="sharp color1">
			...
			<div class="content">
				<s:form name="showSearch"
					action="coursewareAction!listjxjyForPage1?page=1" method="post">
					<table>
						<tr height="20px">
							<td>
						...
						<c:forEach items="${pageBean.list}" var="x">
							<tr>
								...
								<c:if test="${session.userInfo.role=='2'}">
	                                   ...
	                                   <a
										href="coursewareAction!deleteCourseware?searchCoursewareID=${x.id}&type=${x.category}"
			...
			<table width="800" style="table-layout: fixed" border="0"
				...
				<tr>
					<td align="center" style="table-layout: fixed">
						<form action="coursewareAction!listjxjyForPage1" method="post">
							共
