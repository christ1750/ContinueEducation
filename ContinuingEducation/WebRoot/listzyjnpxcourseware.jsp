   ...
   function del(){
	...
	<body>
		...
		<div class="sharp color1">
			...
			<div class="content">
				<s:form name="showSearch"
					action="coursewareAction!listzyjnpxForPage1?page=1" method="post">
					<table>
						<tr height="20px">
							<td>
		...
		<div id="pageing">
			...
			<table width="800" style="table-layout: fixed" border="0"
				...
				<tr>
					<td align="center" style="table-layout: fixed">
						<form action="coursewareAction!listzyjnpxForPage1" method="post">
							共
			...
			　　　　</s:if>
							<s:else>
								<a href="coursewareAction!listzyjnpxForPage1?page=1">第一页</a>
								<a
									href="coursewareAction!listzyjnpxForPage1?page=<s:property value="%{pageBean.currentPage-1}"/>">上一页</a>
							</s:else>
							<s:if test="%{pageBean.currentPage != pageBean.totalPage}">
								<a
									href="coursewareAction!listzyjnpxForPage1?page=<s:property value="%{pageBean.currentPage+1}"/>">下一页</a>
								<a
									href="coursewareAction!listzyjnpxForPage1?page=<s:property value="pageBean.totalPage"/>">最后一页</a>
							</s:if>
							<s:else>下一页      最后一页
